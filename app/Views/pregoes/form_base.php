    ...
    <?php if (!empty($ultimosR0)): ?>
        <div class="recent-table-card">
            <div class="recent-table-title">
                ...
                <span>Últimos 5 pregões cadastrados</span>
            </div>
...
<div class="row justify-content-center">
    <div class="col-12 col-xl-10">
        <div class="d-flex align-items-center mb-3">
            <div>
                <h1 class="h4 mb-0">Cadastre novo pregão base</h1>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                >
                    ...
                    <!-- Linha 3 -->
                    <div class="col-12">
                        <label class="form-label">Objeto licitado</label>
                    ...
                    <div class="col-12 text-end">
                        <a href="<?= url('pregoes') ?>" class="btn btn-neutro">Cancelar</a>
                        <button class="btn btn-sucesso ms-2" type="submit">Salvar</button>
                    </div>
                </form>
            </div>
        </div>
